...
void lua_register_door(sol::state_view &sv) {
	...
	// door["ForceClose"] = sol::overload((void(Lua_Door::*)(Lua_Mob)) & Lua_Door::ForceClose,(void(Lua_Door::*)(Lua_Mob, bool)) & Lua_Door::ForceClose);
	// door["ForceOpen"] = sol::overload((void(Lua_Door::*)(Lua_Mob)) & Lua_Door::ForceOpen,(void(Lua_Door::*)(Lua_Mob, bool)) & Lua_Door::ForceOpen);
