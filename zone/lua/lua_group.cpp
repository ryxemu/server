...
void lua_register_group(sol::state_view& sv) {
	...
	// group["DoesAnyMemberHaveExpeditionLockout"] = sol::overload((bool(Lua_Group::*)(std::string, std::string)) & Lua_Group::DoesAnyMemberHaveExpeditionLockout,(bool(Lua_Group::*)(std::string, std::string, int)) & Lua_Group::DoesAnyMemberHaveExpeditionLockout);
	...
	// group["SplitMoney"] =sol::overload((void(Lua_Group::*)(uint32, uint32, uint32, uint32)) & Lua_Group::SplitMoney,(void(Lua_Group::*)(uint32, uint32, uint32, uint32, Lua_Client)) & Lua_Group::SplitMoney);
