...
void lua_register_iteminst(sol::state_view &sv) {
	auto iteminst = sv.new_usertype<Lua_ItemInst>("ItemInst", sol::constructors<Lua_ItemInst(), Lua_ItemInst(int), Lua_ItemInst(int, int)>());
	...
	// iteminst["GetItem"] = sol::overload((Lua_Item(Lua_ItemInst::*)(void)) & Lua_ItemInst::GetItem,(Lua_ItemInst(Lua_ItemInst::*)(int)) & Lua_ItemInst::GetItem);
	...
	// iteminst["IsEquipable"] = sol::overload((bool(Lua_ItemInst::*)(int)) & Lua_ItemInst::IsEquipable,(bool(Lua_ItemInst::*)(int, int)) & Lua_ItemInst::IsEquipable);
	...
	// iteminst["SetCustomData"] =sol::overload((void(Lua_ItemInst::*)(std::string, bool)) & Lua_ItemInst::SetCustomData,(void(Lua_ItemInst::*)(std::string, float)) & Lua_ItemInst::SetCustomData,(void(Lua_ItemInst::*)(std::string, int)) & Lua_ItemInst::SetCustomData,(void(Lua_ItemInst::*)(std::string, std::string)) & Lua_ItemInst::SetCustomData);
