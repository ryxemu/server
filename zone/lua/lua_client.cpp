...
void lua_register_client(sol::state_view &sv) {
	...
	client["CreateExpedition"] = sol::overload(
	    ...
	    (Lua_Expedition(Lua_Client::*)(std::string, uint32, uint32, std::string, uint32, uint32)) & Lua_Client::CreateExpedition,
	    (Lua_Expedition(Lua_Client::*)(std::string, uint32, uint32, std::string, uint32, uint32, bool)) & Lua_Client::CreateExpedition);
