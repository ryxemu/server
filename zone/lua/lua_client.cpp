...
void lua_register_client(sol::state_view &sv) {
	...
	// client["AddEXP"] = sol::overload((void(Lua_Client::*)(uint32)) & Lua_Client::AddEXP, (void(Lua_Client::*)(uint32, int)) & Lua_Client::AddEXP, (void(Lua_Client::*)(uint32, int, bool)) & Lua_Client::AddEXP);
	// client["AddExpeditionLockout"] = sol::overload((void(Lua_Client::*)(std::string, std::string, uint32)) & Lua_Client::AddExpeditionLockout, (void(Lua_Client::*)(std::string, std::string, uint32, std::string)) & Lua_Client::AddExpeditionLockout);
	// client["AddExpeditionLockoutDuration"] = sol::overload((void(Lua_Client::*)(std::string, std::string, int)) & Lua_Client::AddExpeditionLockoutDuration, (void(Lua_Client::*)(std::string, std::string, int, std::string)) & Lua_Client::AddExpeditionLockoutDuration);
	...
	// client["AddLevelBasedExp"] = sol::overload((void(Lua_Client::*)(int)) & Lua_Client::AddLevelBasedExp, (void(Lua_Client::*)(int, int)) & Lua_Client::AddLevelBasedExp, (void(Lua_Client::*)(int, int, bool)) & Lua_Client::AddLevelBasedExp);
	// client["AddMoneyToPP"] = sol::overload((void(Lua_Client::*)(uint32, uint32, uint32, uint32)) & Lua_Client::AddMoneyToPP, (void(Lua_Client::*)(uint32, uint32, uint32, uint32, bool)) & Lua_Client::AddMoneyToPP);
	// client["AddPlatinum"] = sol::overload((void(Lua_Client::*)(uint32)) & Lua_Client::AddPlatinum, (void(Lua_Client::*)(uint32, bool)) & Lua_Client::AddPlatinum);
	...
	// client["AssignTask"] = sol::overload((void(Lua_Client::*)(int)) & Lua_Client::AssignTask, (void(Lua_Client::*)(int, int)) & Lua_Client::AssignTask, (void(Lua_Client::*)(int, int, bool)) & Lua_Client::AssignTask);
	...
	// client["CheckIncreaseSkill"] = sol::overload((void(Lua_Client::*)(int, Lua_Mob)) & Lua_Client::CheckIncreaseSkill, (void(Lua_Client::*)(int, Lua_Mob, int)) & Lua_Client::CheckIncreaseSkill);
	...
	// client["CreateExpedition"] = sol::overload((Lua_Expedition(Lua_Client::*)(sol::table)) & Lua_Client::CreateExpedition, (Lua_Expedition(Lua_Client::*)(std::string, uint32, uint32, std::string, uint32, uint32)) & Lua_Client::CreateExpedition, (Lua_Expedition(Lua_Client::*)(std::string, uint32, uint32, std::string, uint32, uint32, bool)) & Lua_Client::CreateExpedition);
	...
	// client["DeleteItemInInventory"] = sol::overload((void(Lua_Client::*)(int, int)) & Lua_Client::DeleteItemInInventory, (void(Lua_Client::*)(int, int, bool)) & Lua_Client::DeleteItemInInventory);
	...
	// client["DyeArmorBySlot"] = sol::overload((void(Lua_Client::*)(uint8, uint8, uint8, uint8)) & Lua_Client::DyeArmorBySlot, (void(Lua_Client::*)(uint8, uint8, uint8, uint8, uint8)) & Lua_Client::DyeArmorBySlot);
	...
	// client["Fling"] = sol::overload((void(Lua_Client::*)(float, float, float, float)) & Lua_Client::Fling, (void(Lua_Client::*)(float, float, float, float, bool)) & Lua_Client::Fling, (void(Lua_Client::*)(float, float, float, float, bool, bool)) & Lua_Client::Fling);
	// client["ForageItem"] = sol::overload((void(Lua_Client::*)(bool)) & Lua_Client::ForageItem, (void(Lua_Client::*)(void)) & Lua_Client::ForageItem);
	// client["Freeze"] = (void(Lua_Client::*)(void)) & Lua_Client::Freeze;
	// client["GetAAEXPModifier"] = sol::overload((double(Lua_Client::*)(uint32)) & Lua_Client::GetAAEXPModifier, (double(Lua_Client::*)(uint32, int16)) & Lua_Client::GetAAEXPModifier);
	...
	// client["GetBindHeading"] = sol::overload((float(Lua_Client::*)(int)) & Lua_Client::GetBindHeading, (float(Lua_Client::*)(void)) & Lua_Client::GetBindHeading);
	// client["GetBindX"] = sol::overload((float(Lua_Client::*)(int)) & Lua_Client::GetBindX, (float(Lua_Client::*)(void)) & Lua_Client::GetBindX);
	// client["GetBindY"] = sol::overload((float(Lua_Client::*)(int)) & Lua_Client::GetBindY, (float(Lua_Client::*)(void)) & Lua_Client::GetBindY);
	// client["GetBindZ"] = sol::overload((float(Lua_Client::*)(int)) & Lua_Client::GetBindZ, (float(Lua_Client::*)(void)) & Lua_Client::GetBindZ);
	// client["GetBindZoneID"] = sol::overload((uint32(Lua_Client::*)(int)) & Lua_Client::GetBindZoneID, (uint32(Lua_Client::*)(void)) & Lua_Client::GetBindZoneID);
	...
	// client["GetEXPModifier"] = sol::overload((double(Lua_Client::*)(uint32)) & Lua_Client::GetEXPModifier, (double(Lua_Client::*)(uint32, int16)) & Lua_Client::GetEXPModifier);
	...
	// client["GetExpeditionLockouts"] = sol::overload((sol::table(Lua_Client::*)(sol::this_state)) & Lua_Client::GetExpeditionLockouts, (sol::table(Lua_Client::*)(sol::this_state, std::string)) & Lua_Client::GetExpeditionLockouts);
	...
	// client["GetLearnableDisciplines"] = sol::overload((sol::table(Lua_Client::*)(sol::this_state)) & Lua_Client::GetLearnableDisciplines, (sol::table(Lua_Client::*)(sol::this_state, uint8)) & Lua_Client::GetLearnableDisciplines, (sol::table(Lua_Client::*)(sol::this_state, uint8, uint8)) & Lua_Client::GetLearnableDisciplines);
	...
	// client["GetNextAvailableDisciplineSlot"] = sol::overload((int(Lua_Client::*)(int)) & Lua_Client::GetNextAvailableDisciplineSlot, (int(Lua_Client::*)(void)) & Lua_Client::GetNextAvailableDisciplineSlot);
	// client["GetNextAvailableSpellBookSlot"] = sol::overload((int(Lua_Client::*)(int)) & Lua_Client::GetNextAvailableSpellBookSlot, (int(Lua_Client::*)(void)) & Lua_Client::GetNextAvailableSpellBookSlot);
	...
	// client["GetScribeableSpells"] = sol::overload((sol::table(Lua_Client::*)(sol::this_state)) & Lua_Client::GetScribeableSpells, (sol::table(Lua_Client::*)(sol::this_state, uint8)) & Lua_Client::GetScribeableSpells, (sol::table(Lua_Client::*)(sol::this_state, uint8, uint8)) & Lua_Client::GetScribeableSpells);
