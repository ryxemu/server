...
void lua_register_raid(sol::state_view &sv) {
	...
	// raid["DoesAnyMemberHaveExpeditionLockout"] = sol::overload((bool(Lua_Raid::*)(std::string, std::string)) & Lua_Raid::DoesAnyMemberHaveExpeditionLockout,(bool(Lua_Raid::*)(std::string, std::string, int)) & Lua_Raid::DoesAnyMemberHaveExpeditionLockout);
	// raid["GetClientByIndex"] = (Lua_Client(Lua_Raid::*)(int))&Lua_Raid::GetClientByIndex;
	// raid["GetGroup"] = sol::overload((int(Lua_Raid::*)(Lua_Client)) & Lua_Raid::GetGroup,(int(Lua_Raid::*)(const char *)) & Lua_Raid::GetGroup);
	...
	// raid["SplitMoney"] = sol::overload((void(Lua_Raid::*)(uint32, uint32, uint32, uint32, uint32)) & Lua_Raid::SplitMoney,(void(Lua_Raid::*)(uint32, uint32, uint32, uint32, uint32, Lua_Client)) & Lua_Raid::SplitMoney);
