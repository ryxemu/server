...
void lua_register_npc(sol::state_view &sv) {
    auto npc = sv.new_usertype<Lua_NPC>("NPC", sol::constructors<Lua_NPC()>(), sol::base_classes,sol::bases<Lua_Mob, Lua_Entity>());
    npc["GetLoottableID"] = (int(Lua_NPC::*)(void)) & Lua_NPC::GetLoottableID;
    // npc["AI_SetRoambox"] = sol::overload((void(Lua_NPC::*)(float, float, float, float, float)) & Lua_NPC::AI_SetRoambox,(void(Lua_NPC::*)(float, float, float, float, float, uint32, uint32)) & Lua_NPC::AI_SetRoambox);
    // npc["AddAISpell"] =sol::overload((void(Lua_NPC::*)(int, int, int, int, int, int)) & Lua_NPC::AddAISpell,(void(Lua_NPC::*)(int, int, int, int, int, int, int, int)) & Lua_NPC::AddAISpell);
    ...
    // npc["AddItem"] = sol::overload((void(Lua_NPC::*)(int, int)) & Lua_NPC::AddItem, (void(Lua_NPC::*)(int, int, bool)) & Lua_NPC::AddItem,(void(Lua_NPC::*)(int, int, bool, int)) & Lua_NPC::AddItem,(void(Lua_NPC::*)(int, int, bool, int, int)) & Lua_NPC::AddItem,(void(Lua_NPC::*)(int, int, bool, int, int, int)) & Lua_NPC::AddItem,(void(Lua_NPC::*)(int, int, bool, int, int, int, int)) & Lua_NPC::AddItem,(void(Lua_NPC::*)(int, int, bool, int, int, int, int, int)) & Lua_NPC::AddItem,(void(Lua_NPC::*)(int, int, bool, int, int, int, int, int, int)) & Lua_NPC::AddItem);
    // npc["AddLootTable"] = sol::overload((void(Lua_NPC::*)(int)) & Lua_NPC::AddLootTable,(void(Lua_NPC::*)(void)) & Lua_NPC::AddLootTable);
    ...
    // npc["RemoveItem"] = sol::overload((void(Lua_NPC::*)(int)) & Lua_NPC::RemoveItem,(void(Lua_NPC::*)(int, int)) & Lua_NPC::RemoveItem,(void(Lua_NPC::*)(int, int, int)) & Lua_NPC::RemoveItem);
    // npc["ResumeWandering"] = (void(Lua_NPC::*)(void)) & Lua_NPC::ResumeWandering;
    // npc["SaveGuardSpot"] = sol::overload((void(Lua_NPC::*)(void)) & Lua_NPC::SaveGuardSpot,(void(Lua_NPC::*)(bool)) & Lua_NPC::SaveGuardSpot,(void(Lua_NPC::*)(float, float, float, float)) & Lua_NPC::SaveGuardSpot);
    ...
    // npc["SetSimpleRoamBox"] = sol::overload((void(Lua_NPC::*)(float)) & Lua_NPC::SetSimpleRoamBox,(void(Lua_NPC::*)(float, float)) & Lua_NPC::SetSimpleRoamBox,(void(Lua_NPC::*)(float, float, int)) & Lua_NPC::SetSimpleRoamBox);
