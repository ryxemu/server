...
void lua_register_corpse(sol::state_view &sv) {
	auto corpse = sv.new_usertype<Lua_Corpse>("Corpse", sol::constructors<Lua_Corpse()>(), sol::base_classes, sol::bases<Lua_Mob, Lua_Entity>());
	...
	// corpse["RemoveItemByID"] = sol::overload((void(Lua_Corpse::*)(uint32)) & Lua_Corpse::RemoveItemByID,(void(Lua_Corpse::*)(uint32, int)) & Lua_Corpse::RemoveItemByID);
