...
class FixedMemoryVariableHashSet {
	...
	*/
	...
	//! Copy Constructor
	FixedMemoryVariableHashSet(const FixedMemoryVariableHashSet& other) : data_(other.data_),
	                                                                      size_(other.size_),
	...
	FixedMemoryVariableHashSet(FixedMemoryVariableHashSet&& other) : data_(other.data_),
	                                                                 size_(other.size_),
	                                                                 offset_count_(other.offset_count_),
	                                                                 remaining_size_(other.remaining_size_),
	                                                                 current_offset_(other.current_offset_),
