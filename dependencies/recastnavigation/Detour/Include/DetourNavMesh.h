...
#ifdef DT_POLYREF64
//  figure out a multiplatform version of uint64_t
...
private:
	...
	//  These methods are duplicates from dtNavMeshQuery, but are needed for off-mesh connection finding.
	...
	dtNavMeshParams m_params;			///< Current initialization params.  do not store this info twice.
