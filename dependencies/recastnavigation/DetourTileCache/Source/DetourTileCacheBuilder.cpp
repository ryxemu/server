...
static const int MAX_VERTS_PER_POLY = 6;	//  use the DT_VERTS_PER_POLYGON
static const int MAX_REM_EDGES = 48;		//  make this an expression.
...
//  move this somewhere else, once the layer meshing is done.
